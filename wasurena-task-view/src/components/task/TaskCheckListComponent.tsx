...
export const TaskCheckListComponent: FC = ({}) => {
  ...
  const taskCheckList = data?.getTaskCheckDisplayList;
  const categorizeCheckList = getCategorizeCheckList(
        ...
        <>
          ...
          {taskCheckList.length > 0 && (
            <div className="flex flex-col gap-5 min-w-[300px] max-w-[335px]">
              <div className={`${pageTitleStyle()} mt-5`}>
                【期限指定タスク】
              </div>
